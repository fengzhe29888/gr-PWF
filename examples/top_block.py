...
# Title: Top Block
# Generated: Mon Sep  7 21:39:38 2015
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.fir_filter_xxx_0_2 = filter.fir_filter_ccc(Q, (pulse[::-1]))
        self.fir_filter_xxx_0_2.declare_sample_delay(0)
        self.fir_filter_xxx_0_1_0 = filter.fir_filter_ccc(Q, (pulse[::-1]))
        self.fir_filter_xxx_0_1_0.declare_sample_delay(0)
        self.fir_filter_xxx_0_1 = filter.fir_filter_ccc(Q, (pulse[::-1]))
        self.fir_filter_xxx_0_1.declare_sample_delay(0)
        self.fir_filter_xxx_0_0_1 = filter.fir_filter_ccc(Q, (pulse[::-1]))
        self.fir_filter_xxx_0_0_1.declare_sample_delay(0)
        self.fir_filter_xxx_0_0_0_0 = filter.fir_filter_ccc(Q, (pulse[::-1]))
        self.fir_filter_xxx_0_0_0_0.declare_sample_delay(0)
        self.fir_filter_xxx_0_0_0 = filter.fir_filter_ccc(Q, (pulse[::-1]))
        self.fir_filter_xxx_0_0_0.declare_sample_delay(0)
        self.fir_filter_xxx_0_0 = filter.fir_filter_ccc(Q, (pulse[::-1]))
        self.fir_filter_xxx_0_0.declare_sample_delay(0)
        self.fir_filter_xxx_0 = filter.fir_filter_ccc(Q, (pulse[::-1]))
        ...
        self.connect((self.fir_filter_xxx_0_0_0_0, 0), (self.phase_corrector_0_0_0_0, 0))    
        self.connect((self.fir_filter_xxx_0_0_1, 0), (self.phase_corrector_0_0_1, 0))    
        self.connect((self.fir_filter_xxx_0_1, 0), (self.phase_corrector_0_1, 0))    
        self.connect((self.fir_filter_xxx_0_1_0, 0), (self.phase_corrector_0_1_0, 0))    
        self.connect((self.fir_filter_xxx_0_2, 0), (self.phase_corrector_0_2, 0))    
    ...
    def set_pulse(self, pulse):
        self.pulse = pulse
        self.fir_filter_xxx_0.set_taps((self.pulse[::-1]))
        self.fir_filter_xxx_0_0.set_taps((self.pulse[::-1]))
        self.fir_filter_xxx_0_0_0.set_taps((self.pulse[::-1]))
        self.fir_filter_xxx_0_0_0_0.set_taps((self.pulse[::-1]))
        self.fir_filter_xxx_0_0_1.set_taps((self.pulse[::-1]))
        self.fir_filter_xxx_0_1.set_taps((self.pulse[::-1]))
        self.fir_filter_xxx_0_1_0.set_taps((self.pulse[::-1]))
        self.fir_filter_xxx_0_2.set_taps((self.pulse[::-1]))
