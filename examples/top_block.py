...
# Title: Top Block
# Generated: Mon Aug 31 10:24:31 2015
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.noise = noise = np.true_divide(np.random.standard_normal(size=(L,Nt,Nt))+np.random.standard_normal(size=(L,Nt,Nt))*1j,np.sqrt(2))
        ...
        self.noise_hat = noise_hat = np.true_divide(np.random.standard_normal(size=(L,Nt,Nt))+np.random.standard_normal(size=(L,Nt,Nt))*1j,np.sqrt(2))
        ...
        self.blocks_file_source_1 = blocks.file_source(gr.sizeof_gr_complex*2, "/home/zhe/Dropbox/gnuradio_trunk/gnufiles/rx2", True)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*2, "/home/zhe/Dropbox/gnuradio_trunk/gnufiles/rx1", True)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*2, "/home/zhe/Dropbox/gnuradio_trunk/gnufiles/rx3", False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*2, "/home/zhe/Dropbox/gnuradio_trunk/gnufiles/rx4", False)
        ...
        # Connections
        ##################################################
        self.connect((self.PWF_channel_1, 0), (self.blocks_file_sink_0, 0))    
        self.connect((self.PWF_channel_1, 1), (self.blocks_file_sink_0_0, 0))    
        self.connect((self.PWF_pilot_gen_rx_0, 0), (self.PWF_channel_1, 1))    
        self.connect((self.PWF_pilot_gen_rx_0_0, 0), (self.PWF_channel_1, 0))    
        ...
        self.connect((self.blocks_file_source_1, 0), (self.PWF_pilot_receive_rx_0_0, 0))    
        self.connect((self.blocks_throttle_0, 0), (self.PWF_pilot_receive_rx_0, 0))    
    ...
    def set_Nt(self, Nt):
        ...
        self.set_noise(np.true_divide(np.random.standard_normal(size=(self.L,self.Nt,self.Nt))+np.random.standard_normal(size=(self.L,self.Nt,self.Nt))*1j,np.sqrt(2)))
        self.set_noise_hat(np.true_divide(np.random.standard_normal(size=(self.L,self.Nt,self.Nt))+np.random.standard_normal(size=(self.L,self.Nt,self.Nt))*1j,np.sqrt(2)))
